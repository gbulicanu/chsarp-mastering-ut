...
namespace TestNinja.UnitTest.Mocking
{
    ...
    public class BookingHelper_OverlappingBookingsExistTests
    {
        ...
        [Test]
        public void BookingStartsInTheMiddleAndFinishesAfterExistingBooking_ReturnExistingBookingReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(
                new Booking
                {
                    Id = 1,
                    ArrivalDate = After(this.existingBooking.ArrivalDate),
                    DepartureDate = After(this.existingBooking.DepartureDate, days: 2),
                    Reference = "a"
                },
                this.bookingRepository.Object);
        ...
        public void BookingStartsAndFinishesAfterExistingBooking_ReturnEmptyString()
        {
            var result = BookingHelper.OverlappingBookingsExist(
                ...
                {
                    Id = 1,
                    ArrivalDate = After(this.existingBooking.DepartureDate),
                    DepartureDate = After(this.existingBooking.DepartureDate, days: 2),
                    Reference = "a"
                },
                this.bookingRepository.Object);
        ...
        [Test]
        public void OverlapingBookingButNewBookingIsCancelled_ReturnEmptyString()
        {
            var result = BookingHelper.OverlappingBookingsExist(
                new Booking
                {
