    ...
    public class HousekeeperService
    {
        ...
        public void SendStatementEmails(DateTime statementDate)
        {
            ...
            foreach (var housekeeper in housekeepers)
            {
                ...
                var statementFilename = this.statementGenerator.SaveStatement(housekeeper.Oid, housekeeper.FullName, statementDate);
                ...
                try
                {
                    this.emailSender.EmailFile(emailAddress, emailBody, statementFilename,
                        string.Format("Sandpiper Statement {0:yyyy-MM} {1}", statementDate, housekeeper.FullName));
                }
                catch (Exception e)
                {
                    this.xtraMessageBox.Show(e.Message, string.Format("Email failure: {0}", emailAddress),
